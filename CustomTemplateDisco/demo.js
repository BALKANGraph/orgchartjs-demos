window.onload = function () {
  ...
  OrgChart.templates.disco.field_0 = '<text data-width="180" style="font-size: 16px;" font-weight="bold" fill="#831c55" x="15" y="28" text-anchor="start">{val}</text>';
  OrgChart.templates.disco.field_1 = '<text data-width="210" data-text-overflow="multiline" style="font-size: 14px;" font-weight="bold" fill="#afafaf" x="15" y="47" text-anchor="start">{val}</text>';
