window.onload = function () {
  ...
  OrgChart.templates.greyTemplate.field_0 = '<text data-width="230" style="font-size: 18px;" fill="#64696b" x="125" y="30" text-anchor="middle">{val}</text>';
  OrgChart.templates.greyTemplate.field_1 = '<text data-width="230" style="font-size: 18px;" font-weight="bold" fill="#64696b" x="125" y="65" text-anchor="middle">{val}</text>';
  OrgChart.templates.greyTemplate.field_2 = '<text data-width="230" style="font-size: 18px;" fill="#64696b" x="125" y="90" text-anchor="middle">{val}</text>';
  ...
  OrgChart.templates.redTemplate.field_0 = '<text data-width="230" style="font-size: 18px;" fill="white" x="125" y="30" text-anchor="middle">{val}</text>';
