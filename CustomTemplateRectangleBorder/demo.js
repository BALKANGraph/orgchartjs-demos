window.onload = function () {
  ...
  OrgChart.templates.myTemplate.field_0 = '<text data-width="230" style="font-size: 20px;" fill="#777777" x="110" y="55" text-anchor="start">{val}</text>';
  OrgChart.templates.myTemplate.field_1 = '<text data-width="230" data-text-overflow="ellipsis" style="font-size: 16px;" fill="#777777" x="110" y="78" text-anchor="start">{val}</text>';
  OrgChart.templates.myTemplate.field_2 = '<text data-width="230" data-text-overflow="ellipsis" style="font-size: 12px;" fill="#777777" x="110" y="97" text-anchor="start">{val}</text>';
  OrgChart.templates.myTemplate.field_3 = '<text data-width="230" data-text-overflow="ellipsis" style="font-size: 12px;" font-weight="bold" fill="#777777" x="340" y="20" text-anchor="end">{val}</text>';
