window.onload = function () {
  ...
  OrgChart.templates.white.img_0 = 
    ...
    OrgChart.templates.white.nodeMenuButton = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,225,105)" control-node-menu-id="{id}">' +
      ...
      '<rect x="-70" y="44" fill="#fff" fill-opacity="1" width="22" height="22"></rect>' + 
      '</g>';
  ...
  nodes = [
          { id: 1, name: "Denny Curtis", title: "CEO", department: "Directors", img: "https://cdn.balkan.app/shared/2.jpg" },
          ...
          { id: 11, pid: 7, tags: ["whiteUnder"], name: "Ashley Barnett", title: "Sales Manager", department: "Sales", img: "https://cdn.balkan.app/shared/3.jpg" },
          { id: 12, pid: 7, tags: ["whiteUnder"], name: "Caden Ellison", title: "Dev Manager", department: "Development", img: "https://cdn.balkan.app/shared/4.jpg" }
      ];
