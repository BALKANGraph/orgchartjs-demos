      // add style="pointer-events: none;" for drag and drop
      OrgChart.templates.ana.html = '<foreignobject x="50" y="40" width="160" height="150"><div class="table-section"><form><input value="{val}" id="txtNewNodeContentID" type="text" class="input-field"><br /><button type="button" class="btn">Submit</button></form></div></foreignobject>';
...
//            enableDragDrop: true,
      ...
      // To prevent drag and drop clicking on the form, use the commented code
