    ...
    OrgChart.templates.small.node = 
        ...
        OrgChart.templates.small.field_0 = '<text data-width="158" data-text-overflow="ellipsis" style="font-size: 18px;" fill="#fff" x="80" y="18" text-anchor="middle">{val}</text>';
        OrgChart.templates.small.field_1 = '<text data-width="192" data-text-overflow="multiline" style="font-size: 18px;" fill="#757575" x="100" y="57" text-anchor="middle">{val}</text>';
        OrgChart.templates.small.field_2 = '<text data-width="38" data-text-overflow="ellipsis" style="font-size: 18px;" fill="#808080" font-weight="bold" x="180" y="19" text-anchor="middle">{val}</text>';
        OrgChart.templates.small.field_3 = '<text data-width="98" data-text-overflow="ellipsis" style="font-size: 18px;" fill="#fff" font-weight="bold" x="50" y="94" text-anchor="middle">{val}</text>';
        OrgChart.templates.small.field_4 = '<text data-width="98" data-text-overflow="ellipsis" style="font-size: 18px;" fill="#808080" font-weight="bold" x="150" y="94" text-anchor="middle">{val}</text>';
